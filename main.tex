...
\\Il design pattern utilizzato è chiamato \textbf{Diamond Pattern}\cite{diamond} (figura \ref{fig:contracts_flow}) o standard EIP-2535, ossia un approccio che consiste nella costruzione di un sistema di Smart Contract \textbf{modulari}, \textbf{estendibili} ed \textbf{aggiornabili}, con un spazio a disposizione \textit{virtualmente infinito}.
\\Nel dettaglio, un \textbf{Diamond} è un contratto con funzioni esterne messe a disposizione da particolari contratti chiamati \textbf{facets}. Tali contratti vanno visti come entità separate, indipendenti tra loro ma che condividono funzioni, librerie e variabili di stato. 
...
\subsection{Aggiornamento e eliminazione di funzioni}
