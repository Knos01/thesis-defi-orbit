...
Nella finanza centralizzata, ogni singola operazione finanziaria tra due persone (bonifici, prestiti, scambio di risorse) richiede l'interazione con terze parti (tipicamente banche o altri enti).
Ciò richiede tempistiche burocratiche aggiuntive, oltre ai costi dovuti al servizio fornito dagli enti che permettono l'operazione.
\\\\D'altra parte, la finanza decentralizzata (da ora \textit{DeFi}), permette l'interazione tra due soggetti senza l'intermediazione di un sistema centralizzato, bensì mediante un applicativo software costruito sopra la tecnologia blockchain, rendendo le operazioni rapide, aperte a tutti e sicure.


\section{Operazioni in DeFi}

\section{Vantaggi della DeFi}
