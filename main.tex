...
\begin{itemize}
  ...
  \item \textbf{immutabilità} - una volta che una transazione viene salvata sulla blockchain, nessun partecipante alla rete può in alcun modo alterarne il contenuto
  \item \textbf{sicurezza} - la rete è realizzata mediante sistemi crittografici che ne garantiscono la sicurezza
\end{itemize}
...
\[ x * y = k \]
\\dove $x$ corrisponde al numero di mele e $y$ al numero di patate nel contenitore; in genere $k$ è detta \textbf{liquidità} del contenitore.
