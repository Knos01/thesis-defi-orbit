...
\section{Design Patterns dell'architettura}

L'architettura di Orbit (figure \ref{fig:architecture}) presenta numerosi Smart Contracts, ognuno di essi adibito ad una specifica funzione all'interno della suite. 
...
Il contratto che rappresenta lo Smart Vault creato dall'utente è chiamato \textbf{Position Manager}. Il suo compito principale è il gestire le posizione di Uniswap V3 appartenenti all'utente, salvando all'interno di una struttura dati quali moduli sono stati attivati per una relativa posizione.
